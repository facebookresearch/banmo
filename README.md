...
python submit.py scripts/template-mgpu.sh 0,1,2,3,4,5,6,7 sfm-mcats10-lbsn-correspdv-rkopt-ft-100ep-stage3 sfm-mcats10 10001 --num_epochs 100 --lbs --use_corresp --use_viser --flow_dp --root_opt --ks_opt --pose_cnn_path logdir/pose-occ03-cat_600-lbs-corresp-ropt-8gpu/cnn-params_10.pth  --model_path logdir/sfm-mcats10-lbsn-correspdv-rkopt-ft-100ep2/params_100.pth --use_proj --warmup_init_steps 0 --reinit_bone_steps 0 --noanneal_freq --warmup_steps 0 --freeze_proj
```
