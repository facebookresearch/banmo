...
def feat_match_loss(nerf_feat, embedding_xyz, feats, pts, pts_prob, bound, 
    ...
    #pts_pred2 = feat_match(nerf_feat, embedding_xyz, feats, 
    #        bound/2,grid_size=10,is_training=is_training, init_pts=pts_pred1)
    #pts_pred = feat_match(nerf_feat, embedding_xyz, feats, 
    #        bound/4,grid_size=10,is_training=is_training, init_pts=pts_pred2)
